...
\section{Objetivos.}
	...
	\subsection{Objetivos particulares.}
	    ...
	    \begin{figure}[H]
	    	\begin{center}	                      \includegraphics[width=7cm]{./imagenes/Introduccion/scrumban_buckets.jpeg}
        ...
        \section{Organización del documento}
            ...
            \subsection{Capítulo 2. Marco teórico.}
                En esta parte del documento, describiremos puntos esenciales de nuestro trabajo como la definición una red neuronal, cual planeamos utilizar, como es que se compone una canción, cadenas de markov para la generación de textos, así como herramientas y servicios que estamos probando para su futura implementación dentro del trabajo. 
...
%				\end{figure}
				...
				Estos algoritmos de aprendizaje profundo se utilizan comúnmente para problemas relacionados con la traducción de idiomas, el procesamiento del lenguaje natural, el reconocimiento de voz y los subtítulos de imágenes.\par
				\begin{figure}[H]
...
\end{comment}
    ...
    \begin{thebibliography}{20}
		...
		IBM Cloud Education (2020, septiembre 14), What are Recurrent Neural Networks?, [En línea]. Disponible: https://www.ibm.com/cloud/learn/recurrent-neural-networks#toc-what-are-r-btVB33l5 [Último acceso: 26 de marzo del 2021].

	...
	\chapter{\textcolor{azulescom}{Marco teórico}}
		...
		* Running on http://127.0.0.1:5000/
		...
		\begin{table}[H]
			...
			\resizebox{15cm}{!} {
				\begin{tabular}{|l|l|l|}
					Apache & NGINX & Tomcat\\ \hline
					\begin{tabular}[c]{@{}l@{}}Apache viene con ventajas \'utiles \\
						sobre Nginx, como sería su fácil \\
						configuración, muchos módulos, y \\
						un entorno amigable con los \\
						primerizos.\end{tabular} & 
					\begin{tabular}[c]{@{}l@{}}Nginx fue creado para resolver el \\
						llamado "problema c10k", \\
						significando que un servidor web \\
						que usa hilos para manejar \\
						solicitudes del usuario es incapaz \\
						de gestionar más de 10,000 \\
						conexiones al mismo tiempo.\end{tabular} &
					\begin{tabular}[c]{@{}l@{}}Tomcat fue creado específicamente \\
						para aplicaciones Java, mientras \\
						que Apache es un servidor HTTP de\\
						propósito general.\end{tabular}  \\ \hline
					\begin{tabular}[c]{@{}l@{}}De código abierto y gratuito,\\ 
						incluso para su uso comercial. \\
						Software estable y confiable.\\
						Frecuentemente actualizado \\
						incluyendo actualizaciones \\
						regulares a los parches de \\
						seguridad.\end{tabular} & 
					\begin{tabular}[c]{@{}l@{}}Nginx es uno de los servidores\\
						 web que soluciona el problema \\
						 c10k y probablemente el más \\
						 exitoso al hacerlo, no crea un \\
						 nuevo proceso por cada solicitud y\\ 
						 en su lugar, maneja toda solicitud \\
						 entrante en un único hilo.\end{tabular} &
					\begin{tabular}[c]{@{}l@{}}Tomcat es menos configurable \\
						comparado a otros servidores web.\\
						Por ejemplo, para correr \\
						WordPress, la mejor elección es \\
						un servidor HTTP de propósito \\
						general como Apache o Nginx.\end{tabular}  \\ \hline					
					\begin{tabular}[c]{@{}l@{}}Funciona de forma intuitiva, con \\
						sitios web hechos con WordPress.\\
						Comunidad grande y posibilidad \\
						de contactar con soporte \\
						disponible de manera sencilla \\
						en caso de cualquier problema.\end{tabular}
					
				\end{tabular}
			}
			\caption[Apache]{Tabla comparativa de los distintos servidores web contemplados}
			\label{cuadro:VentajasServidor}
		\end{table}
		\lipsum[4]

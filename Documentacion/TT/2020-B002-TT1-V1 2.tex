...
\newpage
	...
	\begin{table}[hbt!]
		\begin{tabular}{|p{4.5cm}|p{4.5cm}|p{4.5cm}|}
			\hline    			
			\rowcolor{guindapoli}
			\hfil {\textbf{\textcolor{white}{Software}}} & \hfil {\textbf{\textcolor{white}{Características}}} & \hfil {\textbf{\textcolor{white}{Precio en el mercado}}} \\
			\hline
 ...
 \chapter{\textcolor{azulescom}{Marco teórico}}
		...
		\begin{table}[hbt!]
			\begin{tabular}{|p{5cm}|p{5cm}|p{5cm}|}
				\hline    			
				\rowcolor{guindapoli}
				{\textbf{\textcolor{white}{Apache}}} & {\textbf{\textcolor{white}{NGINX}}}  & {\textbf{\textcolor{white}{Tomcat}}}\\
				\hline
				Apache viene con ventajas útiles ante Nginx, ya que es fácil de configurar, cuenta con muchos módulos, así como un entorno amistoso con los primerizos. & Nginx fue creado para resolver el llamado “problema c10k”, significando que un servidor web que usa hilos para manejar solicitudes del usuario es incapaz de gestionar más de 10,000 conexiones al mismo tiempo. & Tomcat fue creado con el único propósito de ejecutar para aplicaciones web realizadas en Java, en tanto que Apache es un servidor HTTP de propósito general.\\
				\hline
				De código abierto y gratuito, inclusive si se usa de manera comercial. Software estable y confiable. Frecuentemente actualizado incluyendo actualizaciones regulares a los parches de seguridad. & Nginx es uno de los servidores web que soluciona el problema c10k y seguramente de los más exitoso al hacerlo, no crea un nuevo proceso por cada solicitud y en su lugar, maneja toda solicitud entrante en un único hilo. & Tomcat es menos configurable comparado a otros servidores web.\\
				\hline
				Funciona de forma intuitiva, con sitios web hechos con WordPress. Comunidad grande y posibilidad de contactar con soporte disponible de manera sencilla en caso de cualquier problema. & El modelo basado en eventos de Nginx reparte las solicitudes de los usuarios entre procesos de trabajo de manera eficiente, llevando con ello a una mejor escalabilidad. & \\
				\hline
				Presenta inconvenientes de rendimiento con sitios web los cuales tienen alto tráfico. Al contar con muchas preferencias de configuración esto puede generar vulnerabilidades de seguridad. & Si requieres manejar un sitio web con demasiado tráfico, Nginx es muy buena opción, debido a que es capaz de  realizarlo con un uso mínimo de los recursos. & \\
				\hline
			\end{tabular}

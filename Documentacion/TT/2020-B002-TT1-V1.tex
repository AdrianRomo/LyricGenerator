...
\section{Arquitectura del sistema}
		...
		\begin{table}[h!]
			...
			\begin{tabular}{|c|c|c|c|}
				\hline    			
				\rowcolor{guindapoli}
				\multicolumn{4}{|c|}{\textbf{\textcolor{white}{Herramientas de Software}}}\\
				\hline
				Software & Licencias & Descripción & Costo \\
				\hline
				OpenSSL &  &  & \\ 
				\hline
				MongoDB & & & \\ 
				...
				\hline
			\end{tabular}
			\caption[Horas de trabajo]{Herramientas a utilizar en el presente trabajo terminal}
		\end{table}

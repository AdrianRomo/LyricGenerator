...
\section{Arquitectura del sistema.}
	        ...
	        \begin{enumerate}
	        	...
	        	\item \textbf{Base de datos:} En este módulo se almacenan los datos de canciones, contaremos con una tabla que contenga como principales campos:
	        	\begin{itemize}
	        		\item Artista
	        		\item Género
...
\section{\textcolor{azulescom}{Iteración 1}}
\subsection{Descripción.}

\subsection{Base de Datos} % Explicar como se sacó la Base de Datos
...
%                               				  		%
%   %   %   %   %   %   %   %   %	%   %     
\section{\textcolor{azulescom}{Iteración 2}}
\subsection{Descripción.}
\subsection{Limpieza} % Explicar cómo se limpió la base de datos
\subsection{Regular Expressions} % Explicar qué es una regular expression, cómo se genera y para qué sirve
\subsection{Técnicas de Scrapping} % Explicar la técnica que se usó para scrappear la base de datos
\subsection{Implementación} % Explicar como se obtuvo en código la base de datos limpia
...
%                               				  		%
%   %   %   %   %   %   %   %   %	%   %     
\section{\textcolor{azulescom}{Iteración 3}}
\subsection{Descripción.}
\subsection{Limpieza} % Explicar cómo se limpió la base de datos
\subsection{Regular Expressions} % Explicar qué es una regular expression, cómo se genera y para qué sirve
\subsection{Técnicas de Scrapping} % Explicar la técnica que se usó para scrappear la base de datos
...
%                               				  		%
%   %   %   %   %   %   %   %   %	%   %     
\section{\textcolor{azulescom}{Iteración 4}}
\subsection{Descripción.}
\subsection{Limpieza} % Explicar cómo se limpió la base de datos
\subsection{Regular Expressions} % Explicar qué es una regular expression, cómo se genera y para qué sirve
\subsection{Técnicas de Scrapping} % Explicar la técnica que se usó para scrappear la base de datos

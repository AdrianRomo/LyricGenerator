...
%				\end{figure}
    	...
    	\begin{table}[h!]
    		\begin{tabular}{|p{6.5cm}|p{6.5cm}|}
    			...
    			\hline
    			Su uso es enfocado al análisis de textos. & Sus principales usos son para la generación de textos.\\
    			\hline
    		\end{tabular}
    		\caption[BERTvsGPT-2]{Comparación entre las tecnologías BERT y GPT-2}
    	\end{table}
        Con base en lo anterior y de las pruebas realizadas se determino que se va a utilizar XXXX el resto del trabajo terminal para ayudarnos en la generación de los textos. \pagebreak	

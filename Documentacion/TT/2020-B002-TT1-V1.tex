...
%                                                      																																			  %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Titulo de la Iteracion 3} % Explicar cómo se limpió la base de datos
		\subsection{Descripción}
		\subsection{Subtema} % Explicar qué es una regular expression, cómo se genera y para qué sirve
...
%                                                      																																			  %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
\section{Titulo de la Iteracion 4} % Explicar cómo se limpió la base de datos
		\subsection{Descripción}
		\subsection{Subtema} % Explicar qué es una regular expression, cómo se genera y para qué sirve
		\subsection{Subtema} % Explicar la técnica que se usó para scrappear la base de datos
		\subsection{Subtema} % Explicar como se obtuvo en código la base de datos limpia

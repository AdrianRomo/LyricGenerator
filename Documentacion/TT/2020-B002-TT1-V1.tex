...
%				En esta se tratan de almacenar los objetos completos (\Gls{Estado} y comportamiento), incorpora todos los conceptos del paradigma orientado a objetos (encapsulamiento, herencia, polimorfismo)\par
		...
		* Running on http://127.0.0.1:5000/
		...
		Si se requiere manejar solicitudes, Flask tiene soporte para solicitudes de tipo GET y POST, por defecto Flask solo admite peticiones de tipo GET, si necesitamos hacer uso de peticiones tipo POST estas debe de estar especificada como parámetro de la función route(), por ejemplo:\par
		\begin{center}

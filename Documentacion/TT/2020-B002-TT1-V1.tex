	    	...
	    	\begin{table}[hbt!]\caption{Riesgo tecnológico}% title of Table
	    		...
	    		\resizebox{8cm}{!} {
	    			\begin{tabular}{|c|c|}% centered columns (3 columns)
	    				...
	    				& \begin{tabular}[c]{@{}l@{}}\end{tabular} \\
	    				\hline
	    			\end{tabular}\label{table:Riesgo tecnológico}% is used to refer this table in the text
	    		}
	    	\end{table}
	    	...
	    	\begin{table}[hbt!]\caption{Riesgo operacional}% title of Table
	    		...
	    		\resizebox{8cm}{!} {
	    			\begin{tabular}{|c|c|}% centered columns (3 columns)
	    				...
	    				& \begin{tabular}[c]{@{}l@{}}\end{tabular} \\
	    				\hline
	    			\end{tabular}\label{table:Riesgo operacional}% is used to refer this table in the text
	    		}
	    	\end{table}

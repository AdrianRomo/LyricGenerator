...
\section{Base de Datos} % Explicar como se sacó la Base de Datos
		...
		\begin{figure}[H]
			...
			\centering 
			\caption{Diagrama Entidad Relación de las tablas Finales}
		\end{figure}
...
\section{Modelo para Neural Network} % Explicar cómo se limpió la base de datos
	...
	\end{figure}
	Como se observa, se ingresará la base de datos generada y se utilizará una instancia EC2, que a su vez usará en caso de necesitar más recursos un bucket de S3 para crear checkpoints resultando con el modelo entrenado a través de un número dado de epochs.
...
\end{figure}
La figura anterior, muestra el funcionamiento general entre la aplicación del modelo entrenado para generar lyrics en línea y el usuario final a través de un webserver de Apache.

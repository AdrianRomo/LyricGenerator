...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\chapter{\textcolor{azulescom}{Análisis}}
	   ...
	   \section{Posible Solución} % Como lo resuelvo
	   ...
	   Dicha herramienta de apoyo se realizará con ayuda de la inteligencia artificial, así como de un modelo de red neuronal recurrente para la generación de las nuevas letras musicales, los usuarios de esta herramienta podrán interactuar con la herramienta para generar letras con sus gustos y propuestas.
	   	...
	   	\section{Sistema a Desarrollar} % Que cosas hace el sistema para resolver Que problema resuelvo
	   	\section{Profundización en la solución propuesta} % Porque elegi esas soluciones
...
\section{Modelo para Neural Network} % Explicar cómo se limpió la base de datos
	...
	\begin{figure}[H] \caption{Ejemplo 1 usando cadenas de Markov}
		\includegraphics[scale=.5]{./imagenes/Disenio/Pruebas/Markov1.png}
		\centering 
	\end{figure}
	\begin{figure}[H] \caption{Ejemplo 2 usando cadenas de Markov}
		\includegraphics[scale=.5]{./imagenes/Disenio/Pruebas/Markov2.png}
		\centering 
	\end{figure}
	Se opto por no utilizar cadenas de Markov debido a que en ocasiones las oraciones que genera, en realidad son copia y pega de las oraciones que se encuentran en el dataset, así como en ocasiones se encuentra la misma palabra repetida en la misma oración muchas veces o en algunos casos las oraciones generadas no tienen sentido alguno.\\\\

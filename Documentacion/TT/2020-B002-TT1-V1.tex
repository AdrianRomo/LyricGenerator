...
%				\end{figure}
				...
				\begin{itemize}
					...
					\item \textbf{Aprendizaje supervisado: }Aprendizaje supervisado: el conjunto de entrenamiento contiene entradas y salidas deseadas. De esta manera, la red puede verificar su salida calculada con la salida deseada y tomar las acciones pertinentes para reformular su cálculo.
				\end{itemize}

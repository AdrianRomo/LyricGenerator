...
%		\end{figure}
	    ...
	    El aprendizaje profundo o deep learning es un nombre o enfoque reciente de la inteligencia artificial llamada redes neuronales. Las redes neuronales son una forma de hacer que las computadoras aprendan, en donde la computadora aprende a realizar alguna tarea analizando ejemplos de entrenamiento. Por lo general, estos ejemplos han sido etiquetados previamente.\par
...
%				En esta se tratan de almacenar los objetos completos (\Gls{Estado} y comportamiento), incorpora todos los conceptos del paradigma orientado a objetos (encapsulamiento, herencia, polimorfismo)\par
		...
		\section{Flask}
		Flask es un marco (framework) web, el cual es un modulo de Python el cual permite desarrollar aplicaciones web. No cuenta con un Manejador de Objetos Realacionales u \acrshort{orm} por sus siglas en inglés, pero si cuenta con características como el enrutamiento de URLS y un motor de plantillas. En general es un marco de aplicación web WSGI.\cite{refFlask3}\par
		\acrshort{wsgi} (Interfaz de Puerta de enlace del Servidor Web) la cual es una especificación que describe como se va a comunicar un servidor web con una aplicación web, y como se pueden llegar a enlazar distintas aplicaciones web para procesar una solicitud o una petición.\cite{refFlask2}\par
		...
		Para poder hacer esto, en la terminal escribimos:\par
		\begin{center}
		virtualenv --no-site-packages myapp\par
		\end{center}
		Al usar ese comando creará un directorio con la siguiente estructura:\par
		\begin{itemize}
		    \item myapp/
		    \begin{itemize}
		        \item bin/
...
%	    Una de las técnicas de autentificación que actualmente se usa es ''recordar la sesión'' usando las ''cookies'', en la siguiente sección, nos adentraremos en definir qué son las cookies y exponer sus vulnerabilidades.
		...
		\begin{table}[hbt!]\caption{Tabla comparativa de las diversas plataformas contempladas}% title of Table
			...
			\resizebox{15cm}{!} {
				\begin{tabular}{c c c c}% centered columns (3 columns)
					...
					\hline                  % inserts single horizontal line
					\begin{tabular}[c]{@{}l@{}}Hosted and/or local\\notebook\end{tabular}
		...
		\begin{table}[hbt!]\caption{Tabla comparativa GCP vs AWS}% title of Table
			\centering % used for centering table
			\resizebox{15cm}{!} {
				\begin{tabular}{c c c}% centered columns (3 columns)
					\hline\hline                        %inserts double horizontal lines
					Tipo de Instancia
					& \begin{tabular}[c]{@{}l@{}}Precio de EC2\\(por hora)\end{tabular} 
					& \begin{tabular}[c]{@{}l@{}}Precio de Google\\(por hora)\end{tabular}\\ [0.5ex]% inserts table %heading
					\hline                  % inserts single horizontal line
...
%   %   %   %   %   %   %   %   %	%   %     
	\part{Iteración 1.}
	\chapter{\textcolor{azulescom}{Base de Datos}} % Explicar como se sacó la Base de Datos
	\chapter{\textcolor{azulescom}{Género Musical}} % Explicar por qué se sacó de este género musical
	\chapter{\textcolor{azulescom}{Resultados}}
	%   %   %   %   %   %   %   %   %	%	%
	%		       											%
	%   				Iteración 2 					  %
	%                               				  		%
	%   %   %   %   %   %   %   %   %	%   %     
	\part{Iteración 2.}
	\chapter{\textcolor{azulescom}{Limpieza}} % Explicar cómo se limpió la base de datos
	\chapter{\textcolor{azulescom}{Regular Expressions}} % Explicar qué es una regular expression, cómo se genera y para qué sirve
	\chapter{\textcolor{azulescom}{Técnicas de Scrapping}} % Explicar la técnica que se usó para scrappear la base de datos
	\chapter{\textcolor{azulescom}{Implementación}} % Explicar como se obtuvo en código la base de datos limpia
	\chapter{\textcolor{azulescom}{Resultados}} % Explicar los Resultados
		%   %   %   %   %   %   %   %   %	%	%
	%		       											%
	%   				Iteración 3 					  %
	%                               				  		%
	%   %   %   %   %   %   %   %   %	%   %     
	\part{Iteración 3.}
	\chapter{\textcolor{azulescom}{Herramientas}} % Herramientas para generar el modelo
	\chapter{\textcolor{azulescom}{Modelo}} % Explicar las partes del modelo con sus diagramas
	\chapter{\textcolor{azulescom}{Implementación}} % Explicar como se implementó con código o pasos para obtener el modelo en AWS
	\chapter{Resultados} % Explicar los Resultados
		%   %   %   %   %   %   %   %   %	%	%
	%		       											%
	%   				Iteración 4 					  %
	%                               				  		%
	%   %   %   %   %   %   %   %   %	%   %     
	\part{Iteración 4.}
	\chapter{\textcolor{azulescom}{Integración}} % Explicar cómo se configuró el modelo en la nube 
	\chapter{\textcolor{azulescom}{Herramientas}} % Explicar las herramientas más a fondo
	\chapter{\textcolor{azulescom}{Implementación}} % Explicar como se implementó con código o pasos para obtener el modelo en AWS
	\chapter{\textcolor{azulescom}{Resultados}} % Explicar los Resultados
    	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		%                                                       %
		...
		%                                                       %
		%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    	\begin{comment} % ESTO SI VAAAAAAA

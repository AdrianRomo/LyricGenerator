    ...
    return (
        <>
            <div className='faq-container'>
                ...
                <p>Si, Lyrics.ia puede aceptar más de 1 palabra para generar una canción,</p>
                ...
                <p>La base de datos utilizada para la construcción del modelo de Lyrics.ia es de un solo género musical,</p>
